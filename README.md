...
# Warp: Svelte + Capacitor (w/ live reload) Project Template

This is a project template for [Warpcode](https://warpcode.io) using [Svelte](https://svelte.dev) + [CapacitorJS](https://capacitorjs.com) apps with live reload, granting the ability to quickly build production ready applications for Web, iOS and Android at near-native performance using JavaScript (Svelte). 
## Changelog
